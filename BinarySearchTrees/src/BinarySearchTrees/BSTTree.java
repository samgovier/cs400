...
public class BSTTree<T extends Comparable<T>> implements BinarySearchTreeADT<T>
{
	...
	*/
	 ...
	 * adds a node maintaining BST rules
	 * @param current   the root of this subtree
	 * @param element   the element to be added
	 *     if element is a duplicate, do nothing
	...
	/*
	 * private recursive helper method
	 * removes a node maintaining BST rules
	 * @param current   the root of this subtree
	 * @param element   the element to be removed
	...
	/*
	 * calls a private recursive helper method
	 * to search the tree for that element
	...
	/*
	 * private recursive helper method
	 * finds whether an element exists in the tree
	 * @param current   the root of this subtree
	 * @param element   the element to be found
